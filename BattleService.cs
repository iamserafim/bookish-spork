...
using ToxicHyppoGame.Contracts;
using ToxicHyppoGame.Authentication;
using ToxicHyppoGame.Data;
using GrpcMessageSender = Grpc.Core.IAsyncStreamWriter<Google.Protobuf.WellKnownTypes.Any>;

namespace ToxicHyppoGame.Pvp.Services;


[Authorize]
internal sealed class BattleService : ToxicHyppoGame.Contracts.BattleService.BattleServiceBase
{
    private readonly ICurrentPlayerProvider _currentPlayerProvider;
    private readonly IBroadcaster _broadcaster;
    private readonly IRoomHub _roomHub;
    private readonly ToxicHyppoGameDbContext _dbContext;
    ...
    public BattleService(
        ...
        IRoomHub roomHub,
        ToxicHyppoGameDbContext dbContext,
        ILogger<BattleService> logger, ICurrentPlayerProvider currentPlayerProvider)
    {
        _roomHub = roomHub;
